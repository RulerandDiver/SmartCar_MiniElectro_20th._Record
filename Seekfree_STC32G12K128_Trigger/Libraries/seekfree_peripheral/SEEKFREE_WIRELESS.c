...
void Test_Wireless_Oscilloscope(void)
{
	...
	// 设置数据
	seekfree_assistant_oscilloscope_data.dat[0] = Left_High_Speed;
	seekfree_assistant_oscilloscope_data.dat[1] = encoder_L;
	seekfree_assistant_oscilloscope_data.dat[2] = Right_High_Speed;
	seekfree_assistant_oscilloscope_data.dat[3] = encoder_R;
	
	seekfree_assistant_oscilloscope_data.dat[4] = eleOut;
	// 需要传输四个通道数据
