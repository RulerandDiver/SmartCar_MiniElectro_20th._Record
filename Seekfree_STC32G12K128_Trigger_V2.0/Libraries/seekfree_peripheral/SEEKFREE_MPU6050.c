...
uint8 mpu6050_init(void)
{
    ...
    mpu6050_simiic_write_reg(MPU6050_DEV_ADDR, GYRO_CONFIG, 0x18);  //2000
		mpu6050_simiic_write_reg(MPU6050_DEV_ADDR, ACCEL_CONFIG, 0x08); //4g //0x10 -- 8g，4g为传统用法
...
void Test_MPU6050(void)
{
	...
	while(1)
	{
		...
		oled_p6x8str_spi(0,0,"gyro_x:");	
		oled_int16_spi(6*8,0,mpu6050_gyro_x);
		oled_p6x8str_spi(0,1,"gyro_y:");	
		oled_int16_spi(6*8,1,mpu6050_gyro_y);
		oled_p6x8str_spi(0,2,"gyro_z:");	
		oled_int16_spi(6*8,2,mpu6050_gyro_z);
